...
public class DemoData {
    ...
    public void appReady(ApplicationReadyEvent event) {
        ...
        Room room1 = new Room(1, twoSingleBeds, new ArrayList<>(), building1);
        room1 = roomRepository.save(room1);
        Room room2 = new Room(2, twoSingleBeds, new ArrayList<>(), building1);
        room2 = roomRepository.save(room2);
        Room room3 = new Room(3, twoSingleBeds, new ArrayList<>(), building1);
        room3 = roomRepository.save(room3);
        Room room4 = new Room(4, twoSingleBeds, new ArrayList<>(), building1);
        room4 = roomRepository.save(room4);
        Room room5 = new Room(5, oneDoubleOneSingleBeds, new ArrayList<>(), building1);
        ...
        Room room6 = new Room(6, twoSingleBeds, new ArrayList<>(), building2);
        room6 = roomRepository.save(room6);
        Room room7 = new Room(7, twoSingleBeds, new ArrayList<>(), building2);
        ...
        Room room8 = new Room(8, twoSingleBeds, new ArrayList<>(), building3);
        room8 = roomRepository.save(room8);
        Room room9 = new Room(9, twoSingleBeds, new ArrayList<>(), building3);
...
//        roomVacation2.setVacation(vacation);
        List<RoomVacation> roomVacationList = new ArrayList<>(Arrays.asList(roomVacation1));
        vacation.setRoomVacationList(roomVacationList);

        Vacation.CustomDate customDate = new Vacation.CustomDate();
        customDate.setArrivalDate(LocalDate.now().plusDays(4));
        customDate.setArrivalDayPart(Vacation.DayPart.MORNING);
        customDate.setLeaveDate(LocalDate.now().plusDays(20));
        ...
        roomVacation22.setVacation(vacation);
        ...
        customDate2.setArrivalDate(LocalDate.now().plusDays(1));
        customDate2.setArrivalDayPart(Vacation.DayPart.MORNING);
        customDate2.setLeaveDate(LocalDate.now().plusDays(10));
